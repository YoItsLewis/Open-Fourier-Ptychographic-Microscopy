...
**Open Fourier Ptychographic Microscopy (OpenFPM)** is a low-cost, modular, and open-source platform for Fourier Ptychographic Microscopy (FPM). It combines programmable LED illumination, 3D-printed optomechanical components, and computational reconstruction to enable high-resolution, wide field-of-view imaging using accessible hardware, with the microscopy body fundamentally based on the [OpenFlexure Project](https://openflexure.org/projects/microscope/build) version 7.

Traditional FPM systems are often built by modifying commerical microscopes, which can limit flexibility and reproducibility. OpenFPM addresses this by providing a fully integrated, purpose-built architecture where optics, illumination, mechanics, and control software are designed to work together.

The platform supports multi-angle illumination, synthetic numerical aperture enhancement, and digital aberration correction, while remaining compact and affordable. By levergaing open-source design files and widely available components, OpenFPM lowers the barrier to entry for computational microscopy in research, education, and resource-limited enviroments.
...
All 3D printed components were fabricated using a fused deposition modelling (FDM) printer with matte black polylactic acid (PLA) filament at 0.2 mm layer height. Default print setting were used and automatic tree supports were applied were necessary.
...
This materials list is for building the system, assuming users have access to IT equipment, and tools for printing and optomechanics.

| Parts | Purpose | Source | Quantity | Price (£) |
|-----|-----|-----|-----|-----|
| **Electronic Components** |
| Raspberry Pi 4 Model B Starter Kit (1GB) | Microcomputer for controlling the microscope | [The Pi Hut](https://thepihut.com/products/raspberry-pi-4-model-b?gad_source=1&gad_campaignid=18204675107&gbraid=0AAAAADfQ4GHs7KTna-5hPrxHnBQRcNmOU&gclid=CjwKCAjwyYPOBhBxEiwAgpT8P2JjaA_E7a_RDuct0f0p10xqSjnCeNwCVmL12x8CcJjqilPyyiZlHRoCuTMQAvD_BwE&variant=41005997392067) [Pimoroni](https://shop.pimoroni.com/products/raspberry-pi-4?variant=39576373690451)| 1 | ~£35 |
...
[Python script](https://github.com/YoItsLewis/Open-Fourier-Ptychographic-Microscopy/tree/main/Software) for controlling the microscope on the Raspberry Pi. Graphical User Interface should work using a monitor or through remote desktop connection.
